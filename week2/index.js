...
var l = "8";
// 請文字解釋為什麼
console.log(k * l > 21); // String與Number相乘時, String會嘗試轉型為Number,若String不適合轉換為Number則結果會是NaN
...
switch (true) {
	case coachIncome > 300000:
		coachBonus += coachIncome * 0.2;
		break;
	case coachIncome >= 100000 && coachIncome <= 300000:
		coachBonus += coachIncome * 0.15;
		break;
	default:
		coachBonus += coachIncome * 0.1;
	...
	coaches: [
		{
			...
			skill: "力量訓練、減重課程",
			course: {
				personal: "每次收費 2000 元，課程時長 60 分鐘，目前有空堂。",
				group: "每次收費 1500 元，課程時長 90 分鐘，目前無空堂。",
			},
			coachesBackground: "王教練擁有 5 年教學經驗，專精於提升學員的肌力與減脂，適合希望快速達成體能目標的學員。",
		...
		},
		{
			...
			skill: "瑜伽、體態雕塑",
			course: {
				personal: "每次收費 1800 元，課程時長 50 分鐘，目前無空堂。",
				group: "每次收費 1200 元，課程時長 75 分鐘，目前有空堂。",
			},
			coachesBackground: "李教練是一位瑜伽大師，擁有 10 年教學經驗，擅長幫助學員雕塑完美體態，適合希望改善姿態與柔軟度的學員。",
...
if (performanceData["coaches"][0]['performance'] < 50000 ) {
  performanceData["coaches"][0]["is_standard"] = false
}
...
if (performanceData["coaches"][1]["performance"] < 50000) {
	performanceData["coaches"][1]["is_standard"] = false;
}
...
// 練習：計算小明今日消耗的卡路里
calorieBurn += activities.cycle * 10 + activities.run * 30 + activities.yoga * 40 + activities.cycle * 10;
